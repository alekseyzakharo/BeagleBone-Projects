 ...
 *******************************************************************************/
#define TIMER_INITIAL_COUNT             (0xFFFC2F6F)  // 10ms
...
static void (*s_isrCallbackOne)(void) = 0;
static void (*s_isrCallbackTwo)(void) = 0;
...
void Timer_setTimerIsrCallbackOne(void (*isrCallback)(void)) {
	s_isrCallbackOne = isrCallback;
}

void Timer_setTimerIsrCallbackTwo(void (*isrCallback)(void)) {
	s_isrCallbackTwo = isrCallback;
}
...
static void DMTimerIsr(void)
{
	...
	if (s_isrCallbackOne != 0) {
		s_isrCallbackOne();
	}
	if (s_isrCallbackTwo != 0) {
		s_isrCallbackTwo();
	}
	// --------------------------------------------------------
